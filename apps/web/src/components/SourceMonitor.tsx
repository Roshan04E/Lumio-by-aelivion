...
export const SOURCE_DRAG_MIME = "application/x-orreris-source-drag";
  ...
  return (
    <section
      ...
      onDragOver={(event) => {
        ...
        if (onLoadAssetId && event.dataTransfer.types.includes("application/x-orreris-asset") && !event.dataTransfer.types.includes(SOURCE_DRAG_MIME)) {
          event.preventDefault();
