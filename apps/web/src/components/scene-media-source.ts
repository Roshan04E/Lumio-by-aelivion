/**
 * Single-context GPU-first preview (Phase 5, flag `lumio.singleCtxPreview`) — the seam between
...
import type { ColorPipeline, MediaEffects, MediaTransition } from "@lumio-by-aelivion/shared";
