 ...
 *
 * The text/shape rasterizer moved into `@kimera-by-aelivion/shared` (packages/shared/src/scene/scene-text-raster.ts)
...
export { SceneTextRasterizer, type SceneRaster } from "@kimera-by-aelivion/shared";
