 ...
 *
 * Persistence: localStorage `orreris.graphicPresets` (device-local, mirrors effect-presets.ts).
 * Corrupt/legacy payloads are dropped silently — presets are convenience data.
 */

import type { LayerGraphic } from "@orreris/shared";
...
const STORAGE_KEY = "orreris.graphicPresets";
