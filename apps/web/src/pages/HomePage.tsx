      ...
      <section className="mkt-hero">
        <div className="mkt-wrap mkt-hero-inner">
          ...
          <p className="mkt-sub">
            ...
            free with your own chat assistant, or run instantly inside Orreris. Same editable result either way.
          </p>
          ...
          <div className="mkt-shell">
            <div className="mkt-shell-bar">
              ...
              <span className="proj">your_reel.orreris</span>
              <span className="push" />
              <button type="button" className="exp" onClick={() => navigate("/create")}>Try it →</button>
            </div>
            <div className="mkt-nle" role="img" aria-label="The Orreris editor: media bin, effects, a viewer with live scopes and color wheels, an inspector, and a multi-track timeline with clips, waveforms, keyframes, and a transition.">
              {/* app toolbar */}
      ...
      <section id="ai-paths" className="mkt-section">
        <div className="mkt-wrap">
          <div className="mkt-sec-head">
            ...
            <p>
              Orreris never locks results behind a subscription. Bring your own chat assistant for free, or
              let Orreris run the model for you — both produce the same editable timeline data.
            </p>
          </div>
          ...
          <div className="mkt-paths">
            <div className="mkt-path">
              ...
              <div className="mkt-flow">
                <div className="mkt-step"><span className="n">01</span> Open a tool — Orreris builds a precise prompt</div>
                <div className="mkt-step"><span className="n">02</span> Paste it into your own chat assistant</div>
                <div className="mkt-step"><span className="n">03</span> Paste the result back into Orreris</div>
                <div className="mkt-step"><span className="n">04</span> Orreris validates it into editable layers</div>
              </div>
            </div>
            ...
            <div className="mkt-path integrated">
              ...
              <h3>Run it inside Orreris</h3>
              <span className="price">Included with a plan — no copy-paste</span>
              <div className="mkt-flow">
                <div className="mkt-step"><span className="n">01</span> Ask Orreris chat what you want</div>
