...
- Basis: `project-tracker/adr/013-media-acquisition-scheduling.md` (definitions), `project-tracker/adr/
  ...
  (both rejected — see `project-tracker/architectural-debt.md`, DEBT-013, 2026-08-07). **Slice B (F2,
  virtual-source contribution) is proposed and unimplemented** — nothing is attributable to it yet.
...
| **I-48** | Still needed | Unchanged from ADR-020 §6's own finding: satisfied in letter, defeated in substance for the Flarex virtual-source class (`collectFlarexVirtualLayers` stamps a fabricated identity transform). The fix is slice B, which remains unimplemented. |
...
I-52, C17, C18) — deferred whole, per scope. Of the remaining 9, none are attributable to slice B, which
is unimplemented; I-48 stays exactly as ADR-020 characterized it in 2026-08-06.
...
| **I-48** | **Storm-needed** | The live violation (fabricated virtual-source contribution, `collectFlarexVirtualLayers`) occurs whenever the graph is ranked at all — at mount or on a graph edit — not only under sustained contention. |
