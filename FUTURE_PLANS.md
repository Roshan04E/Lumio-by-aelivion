...
The important limitation: **YouTube Content ID API is only for approved YouTube content partners**, not normal apps/users. So Orreris/ReelForge cannot directly ask YouTube, “will this get claimed?” before upload. ([Google for Developers][2])

## What Orreris can build
...
```ts
{
  source: "local" | "pexels" | "pixabay" | "ai_generated" | "orreris_library",
...
* “known source” validation for Pexels/Pixabay/Orreris library
...
2. **Safe asset sources**: Pexels, Pixabay, Orreris library.
...
For Orreris, this feature is still very powerful. It makes your editor feel professional and creator-safe. It can become a strong differentiator, especially for beginners who don’t understand claims, strikes, licenses, stock assets, and music rights.
