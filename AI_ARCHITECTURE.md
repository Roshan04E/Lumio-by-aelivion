# Orreris Brain — AI Architecture & Build Plan

> **What this file is:** the architecture and phased build plan for Orreris's AI **brain** — the
...
> [`ORRERIS_OS.md`](ORRERIS_OS.md) is the decade-scale north star (World Model, Blueprint IR,
...
Orreris is **a professional video editor with an AI operating system on top** — not an "AI video
generator." The editor is fully usable without AI; the AI *operates the editor's tools*:

```
User → Orreris AI → Editor Tools → Timeline / Layers / Effects
```
...
- **Editor knowledge**: "play the video", "how do I pan" — answered from a small curated table
  of real Orreris shortcuts (the timeline cheat-sheet is the source of truth), instantly and
